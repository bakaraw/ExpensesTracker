        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex gap-x-4">
                <div class="w-3/5 bg-gray-100 flex-shrink-0 flex flex-col">
                    ...
                    <div class="mt-4 w-full bg-white rounded-lg px-3 py-2 flex-grow ">
                                ...
                                <div class="flex flex-row justify-between w-full">
                                    <div class="flex-1 items-center justify-between">
                                        ...
                                        <p class="text-sm text-gray-700">Remaining: PHP
                                            {{ $budget_portion->portion -
                                            $trans_with_category[$budget_portion->category->name] }}
                                        </p>
                                    </div>
                                    <div class="flex-1 flex flex-col items-end">
                                        <p class="font-bold text-lg">PHP {{ $budget_portion->portion }}</p>
                                        <p class="text-sm text-gray-700">Expenses:
                                            {{ $trans_with_category[$budget_portion->category->name] }}</p>
                                    </div>
            ...
            <form action="{{ route('budgeting.add-expense') }}" method="post">
                ...
                <div class="mt-3">
                    ...
                    <div class="scroll-smooth max-h-40 snap-y overflow-y-auto mb-3">
                        ...
                        @endphp
                        <div class="border border-gray-200 rounded-md mb-3 py-1 px-4 flex justify-between snap-y">
                            <div class="">
    ...
    <x-my-modal name="edit-portion-{{$budget_portion->portion_id}}" width="max-w-lg" height="180">
        <x-slot name="header">
            <h1 class="text-black text-2xl">
                <i class="fa-solid {{$budget_portion->category->icon}} mr-3"></i>{{$budget_portion->category->name}}
                - Edit Portion
            </h1>
        </x-slot>
        <x-slot name="body">
                    ...
                    <div class="w-2/3 pr-4">
                        <div class="w-full">
                            <select
                                ...
                                <option value="{{ $budget_type->id }}" @if ($budget_type->id == $user_budget->type)
                                    selected @endif>
